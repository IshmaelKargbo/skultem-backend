...
public class FeeStructure extends AggregateRoot<String> {
    ...
    public FeeStructure(String id, String schoolId, Type type, Clazz clazz, Term term, FeeCategory category,
            AcademicYear academicYear, boolean allowInstallment, boolean hasSuppy, int totalSupply, LocalDate dueDate,
    ...
    public static FeeStructure create(String schoolId, Type type, Clazz clazz, boolean hasSuppy, int totalSupply, Term term,
            FeeCategory category,
            AcademicYear academicYear, LocalDate dueDate, BigDecimal amount, String description,
            boolean allowInstallment) {
        Instant now = Instant.now();
        String id = UUID.randomUUID().toString();
        return new FeeStructure(id, schoolId, type, clazz, term, category, academicYear, allowInstallment, hasSuppy,
