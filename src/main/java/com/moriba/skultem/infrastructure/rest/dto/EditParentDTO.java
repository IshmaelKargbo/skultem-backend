...
// Same rules as CreateParentDTO. email is optional here: blank leaves it alone, and a parent who has
// none uses "Add Email" instead (see EditParentUseCase).
public record EditParentDTO(
